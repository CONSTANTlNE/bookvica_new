        ...
        <div class="grid grid-cols-12">
            ...
            <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 sm:col-span-8 col-span-12">
                <div style="max-height: 100px" class="my-[1.5rem] flex justify-center">
                    <a href="#">
                        <img style="max-height: 100px" src="{{asset('assets/images/logo.png')}}" alt="logo" class="desktop-logo">
                        <img style="max-height: 100px" src="{{asset('assets/images/logo.png')}}" alt="logo" class="desktop-dark">
                    </a>
                </div>
                <div class="box">
                    ...
                    <div class="box-body !p-[3rem]">
                        ...
                        <div class="grid grid-cols-12 gap-y-4">
                            <div class="xl:col-span-12 col-span-12">
                                ...
                                <input name="email" type="text" class="form-control form-control-lg w-full !rounded-md" id="signin-username" placeholder="user name">
                            </div>
                            @error('email')
                            ...
                            <div class="xl:col-span-12 col-span-12 mb-2">
                                ...
                                <div class="input-group">
                                    <input name="password" type="password" class="form-control form-control-lg !rounded-s-md" id="signin-password" placeholder="password">
