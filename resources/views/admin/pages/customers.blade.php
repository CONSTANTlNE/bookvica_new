...
<div class="grid grid-cols-12  m-auto">
    <div class="col-start-2 sm:col-span-4 col-span-12">
        <div class="box">
        ...
        <tr>
            ...
            <td>
                <div class="hs-dropdown ti-dropdown">
                    ...
                    <ul style="position: absolute" class="hs-dropdown-menu ti-dropdown-menu hidden">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                               data-hs-overlay="#deleteCustomer{{$index}}">Delete Customer
                            </a>

                        </li>
                            <li>
                                <a href="javascript:void(0);" class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                                   data-hs-overlay="#updateCustomer{{$index}}">Edit Customer
                                </a>

                            </li>
                    </ul>
                    <div id="deleteCustomer{{$index}}" class="hs-overlay hidden ti-modal">
                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                            <div class="ti-modal-content">
                                <div class="ti-modal-body px-4">
                                  Delete Customer {{$customer->name}} ? all sales invoices will be deleted !
                                </div>
                                <div class="ti-modal-footer">
                                    <button type="button"
                                            class="hs-dropdown-toggle ti-btn  ti-btn-secondary-full align-middle"
                                            data-hs-overlay="#deleteCustomer{{$index}}">
                                        Close
                                    </button>
                    ...
                    <div id="updateCustomer{{$index}}" class="hs-overlay hidden ti-modal">
                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                <div class="ti-modal-content">
